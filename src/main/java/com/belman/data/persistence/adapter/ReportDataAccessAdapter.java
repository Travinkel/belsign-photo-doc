...
import com.belman.domain.report.*;
import com.belman.data.persistence.memory.InMemoryReportRepository;
...
public class ReportDataAccessAdapter implements ReportDataAccess {
     ...
     */
    private com.belman.domain.user.UserBusiness convertUserBusinessToAggregate(
            com.belman.domain.user.UserBusiness userBusiness) {
     ...
     */
    private com.belman.domain.customer.CustomerAggregate convertCustomerBusinessToAggregate(
            com.belman.domain.customer.CustomerBusiness customerBusiness) {
     ...
     */
    private com.belman.domain.user.UserBusiness convertUserAggregateToBusiness(
            com.belman.domain.user.UserBusiness userAggregate) {
     ...
     */
    private com.belman.domain.customer.CustomerBusiness convertCustomerAggregateToBusiness(
            com.belman.domain.customer.CustomerAggregate customerAggregate) {
