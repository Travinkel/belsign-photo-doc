...
public class UIErrorHandlerAdapter implements ErrorHandler {
    ...
    private final com.belman.ui.error.ErrorHandler uiErrorHandler;
     ...
     */
    public UIErrorHandlerAdapter(com.belman.ui.error.ErrorHandler uiErrorHandler) {
    ...
    public static UIErrorHandlerAdapter createWithDefaultErrorHandler() {
        return new UIErrorHandlerAdapter(com.belman.ui.error.ErrorHandler.getInstance());
    }
