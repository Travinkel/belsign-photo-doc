...
import com.belman.business.error.ErrorHandler;
...
public class UIErrorHandlerAdapter implements ErrorHandler {
    ...
    private final com.belman.presentation.core.ErrorHandler uiErrorHandler;
     ...
     */
    public UIErrorHandlerAdapter(com.belman.presentation.core.ErrorHandler uiErrorHandler) {
    ...
    public static UIErrorHandlerAdapter createWithDefaultErrorHandler() {
        return new UIErrorHandlerAdapter(com.belman.presentation.core.ErrorHandler.getInstance());
    }
}