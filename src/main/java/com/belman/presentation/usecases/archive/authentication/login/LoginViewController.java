...
import com.belman.presentation.usecases.archive.authentication.login.flow.CameraScanLoginState;
import com.belman.presentation.usecases.archive.authentication.login.flow.DefaultLoginContext;
...
public class LoginViewController extends BaseController<LoginViewModel> {
    ...
    private CameraService getCameraService() {
        return ServiceLocator.getService(CameraService.class);
    }
    ...
    private void startCameraPreviewSimulation() {
        ...
        if (cameraService.isCameraAvailable()) {
            ...
            Image placeholderImage = new Image(getClass().getResourceAsStream(
                    "/com/belman/presentation/usecases/authentication/login/camera_placeholder.png"));
