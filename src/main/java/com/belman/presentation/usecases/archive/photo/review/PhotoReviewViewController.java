...
import com.belman.presentation.usecases.archive.photo.upload.TouchFriendlyPhotoListCell;
...
public class PhotoReviewViewController extends BaseController<PhotoReviewViewModel> {
    ...
    private void handleBack(ActionEvent event) {
        ...
        java.util.Optional<UserBusiness> userOpt = SessionContext.getCurrentUser();
