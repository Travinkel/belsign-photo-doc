...
import com.belman.presentation.flow.commands.Command;
import com.belman.presentation.flow.commands.SaveAdminCommand;
...
public class AdminViewModel extends BaseViewModel<AdminViewModel> {
    ...
    // Commands
    private Command<Void> saveCommand;
    ...
    public AdminViewModel(AdminService adminService) {
        ...
        // Create a dummy AdminData for the SaveAdminCommand
        AdminData dummyData = new AdminData("admin", "password", "ADMIN");
        this.saveCommand = new SaveAdminCommand(adminService, dummyData);
    }
    ...
    public AdminViewModel() {
        this.adminService = null; // Will be injected by ServiceLocator
        // Create a dummy AdminData for the SaveAdminCommand
        AdminData dummyData = new AdminData("admin", "password", "ADMIN");
        // Initialize saveCommand with null service (will be injected later)
        this.saveCommand = new SaveAdminCommand(null, dummyData);
    }
