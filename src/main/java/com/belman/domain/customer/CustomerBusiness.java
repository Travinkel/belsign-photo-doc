...
/**
 * Business object representing a customer who can receive QC reports.
 * Can represent either an individual person or a company.
 */
public class CustomerBusiness extends BusinessObject<CustomerId> {
     ...
     */
    private CustomerBusiness(CustomerId id, CustomerType type, PersonName personName, Company company,
        ...
        if (type == CustomerType.INDIVIDUAL) {
            this.personName = Objects.requireNonNull(personName,
                    "personName must not be null for individual customers");
        } else {
     ...
     */
    public static CustomerBusiness individual(CustomerId id, PersonName personName, EmailAddress email) {
        return new CustomerBusiness(id, CustomerType.INDIVIDUAL, personName, null, email, null);
    }
    ...
    public static CustomerBusiness individual(CustomerId id, PersonName personName, EmailAddress email,
        ...
        return new CustomerBusiness(id, CustomerType.INDIVIDUAL, personName, null, email, phoneNumber);
    }
     ...
     */
    public static CustomerBusiness company(CustomerId id, Company company, EmailAddress email) {
        return new CustomerBusiness(id, CustomerType.COMPANY, null, company, email, null);
    }
    ...
    public static CustomerBusiness company(CustomerId id, Company company, EmailAddress email,
                                           PhoneNumber phoneNumber) {
        return new CustomerBusiness(id, CustomerType.COMPANY, null, company, email, phoneNumber);
    }
    ...
    public static class Builder {
        ...
        public CustomerBusiness build() {
            if (type == CustomerType.INDIVIDUAL) {
                return new CustomerBusiness(id, type, personName, null, email, phoneNumber);
            } else if (type == CustomerType.COMPANY) {
                return new CustomerBusiness(id, type, null, company, email, phoneNumber);
            } else {
