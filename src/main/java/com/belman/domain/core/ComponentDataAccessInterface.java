...
/**
 * Generic data access interface for business components.
 * <p>
 ...
 *
 * @param <T>  the type of the business component this interface manages
...
public interface ComponentDataAccessInterface<T extends BusinessComponent<ID>, ID> {
    ...
    /**
     * Saves a business component to the data store. If the business component already exists,
    ...
    /**
     * Deletes a business component from the data store.
     *
    ...
    /**
     * Deletes a business component from the data store by its identifier.
     *
    ...
    /**
     * Finds all business components managed by this data access interface.
     * <p>
    ...
    /**
     * Counts the number of business components managed by this data access interface.
     *
