package com.belman.bootstrap.session;
...
public class SessionManager extends BaseService {
    ...
    public void setCurrentUser(UserBusiness user) {
     ...
     * 
     * @return an Optional containing the authenticated UserBusiness if a user is logged in, or empty if no user is logged in
     */
