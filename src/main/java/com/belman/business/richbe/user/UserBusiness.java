...
import com.belman.business.richbe.events.UserApprovedEvent;
...
public class UserBusiness extends BusinessObject<UserId> {
    ...
    public void approve(UserBusiness reviewer, Instant reviewedAt) {
        ...
        registerAuditEvent((AuditEvent) new UserApprovedEvent(ApprovalStatus.APPROVED));
    }
    ...
    public void reject(UserBusiness reviewer, Instant reviewedAt, String reason) {
        ...
        registerAuditEvent((AuditEvent) new UserApprovedEvent(ApprovalStatus.REJECTED));
    }

    /**
     * Returns an unmodifiable list of audit events emitted by this business object.
     */
    public List<AuditEvent> getAuditEvents() {
        return getRegisteredAuditEvents();
    }

    /**
     * Clears the list of audit events emitted by this business object.
     */
