...
import com.belman.business.richbe.events.AuditPublisher;
 ...
 * This class is designed to be used in the business layer and does not depend on outer layers.
 */
public abstract class BusinessService implements IBusinessService {
    ...
    /**
     * Creates a new BusinessService with a logger for the concrete service class.
     */
