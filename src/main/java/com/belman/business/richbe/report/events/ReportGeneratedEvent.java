package com.belman.business.richbe.report.events;

import com.belman.business.richbe.events.AbstractDomainEvent;
import com.belman.business.richbe.order.OrderId;
import com.belman.business.richbe.report.ReportId;
import com.belman.business.richbe.report.ReportType;
...
/**
 * Domain event that is published when a new report is generated.
 * This event signifies that a report has been created and is ready for further processing.
 */
public class ReportGeneratedEvent extends AbstractDomainEvent {
