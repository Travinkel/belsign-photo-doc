...
BEGIN
    ...
    VALUES ('order001-aaaa-bbbb-cccc-ddddeeeeeeee', 'ORD-TEST-001', 'aabbccdd-1122-3344-5566-778899aabbcc', '20b013bc-3366-4266-9043-48a96b00e8fd', SYSDATETIME(), SYSDATETIME(), 'PENDING', 'Test order 1 for production user', '20b013bc-3366-4266-9043-48a96b00e8fd');
END

IF NOT EXISTS (SELECT 1 FROM ORDERS WHERE order_id = 'order002-ffff-gggg-hhhh-iiiijjjjjjjj')
BEGIN
    INSERT INTO ORDERS (order_id, order_number, customer_id, created_by, created_at, modified_at, status, product_description, assigned_to)
    VALUES ('order002-ffff-gggg-hhhh-iiiijjjjjjjj', 'ORD-TEST-002', 'aabbccdd-1122-3344-5566-778899aabbcc', '20b013bc-3366-4266-9043-48a96b00e8fd', SYSDATETIME(), SYSDATETIME(), 'IN_PROGRESS', 'Test order 2 for production user', '20b013bc-3366-4266-9043-48a96b00e8fd');
END
