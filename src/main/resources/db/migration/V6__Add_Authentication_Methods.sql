...
ALTER TABLE users ADD COLUMN qr_code_hash VARCHAR(100);
...
UPDATE users SET pin_code = '1234' WHERE username = 'pin_user';

-- Update existing users with default QR code hash (for testing)
UPDATE users SET qr_code_hash = 'scanner123hash' WHERE username = 'scanner';