...
public class OrderLoadingWithUserRolesTest {
    ...
    void setUp() {
        ...
        pendingOrder = createOrder("order-1", "ORD-78-230701-PIP-0001", OrderStatus.PENDING, adminUser);
        inProgressOrder = createOrder("order-2", "ORD-78-230702-PIP-0002", OrderStatus.IN_PROGRESS, adminUser);
        completedOrder = createOrder("order-3", "ORD-78-230703-PIP-0003", OrderStatus.COMPLETED, adminUser);
        approvedOrder = createOrder("order-4", "ORD-78-230704-PIP-0004", OrderStatus.APPROVED, adminUser);
