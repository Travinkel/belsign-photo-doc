...
public class MainViewTest {
    ...
    public void test_lifecycle_methods_are_properly_called() {
        ...
        try (MockedStatic<GluonLifecycleManager> lifecycleMock =
                mockStatic(GluonLifecycleManager.class)) {

            // Mock the registerView method to do nothing
            lifecycleMock.when(() -> GluonLifecycleManager.registerView(any())).then(invocation -> null);
