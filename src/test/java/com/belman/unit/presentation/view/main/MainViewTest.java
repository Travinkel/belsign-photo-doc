...
public class MainViewTest {
    ...
    public void test_lifecycle_methods_are_properly_called() {
        ...
        // Disable GluonLifecycleManager registration for this test
        try (MockedStatic<com.belman.backbone.core.lifecycle.GluonLifecycleManager> lifecycleMock = 
                mockStatic(com.belman.backbone.core.lifecycle.GluonLifecycleManager.class)) {

            // Mock the registerView method to do nothing
            lifecycleMock.when(() -> com.belman.backbone.core.lifecycle.GluonLifecycleManager.registerView(any())).then(invocation -> null);
