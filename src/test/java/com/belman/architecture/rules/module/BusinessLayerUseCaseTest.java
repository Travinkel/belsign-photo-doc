...
/**
 * Tests to verify that the business layer follows the correct patterns for usecases.
 * The business layer contains usecases that implement business logic and coordinate between
 * the presentation and data layers.
 */
public class BusinessLayerUseCaseTest {
    ...
    //             .because("Usecases should be in the business layer");
    //
    ...
    public void useCasesShouldNotDependOnRepositoryImplementations() {
        // Usecases should not depend on data implementations
        ArchRule rule = noClasses()
                ...
                .because("Usecases should not depend on data implementations");
